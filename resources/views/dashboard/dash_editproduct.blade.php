          ...
          <div class="col-lg-6">
            ...
            <div class="card-style mb-30">
              ...
              <div class="input-style-1">
                ...
                <input type="text" placeholder="discount" value="{{$product->discount}}" name="discount">
              </div>
              <!-- end input -->
              <!-- end input -->
              <div class="input-style-1">
                <label>Type</label>
                <input type="text" placeholder="Type" value="{{$product->type}}" name="type">
              </div>
              <!-- end input -->
              <!-- end input -->
              <div class="input-style-1">
                <label>Color</label>
                <input type="text" placeholder="Color" value="{{$product->color}}" name="color">
              </div>
              <!-- end input -->
            </div>
            <!-- end card -->
          ...
          <div class="col-lg-6">
            ...
            <div class="card-style mb-30">
              ...
              <div class="input-style-1">
                ...
                <textarea placeholder="Message" id="details" name="details" rows="10"></textarea>
              </div>
              <!-- end textarea -->
